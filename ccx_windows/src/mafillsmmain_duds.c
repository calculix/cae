...
static double *co1,*xboun1,*coefmpc1,*xforc1,*xload1,*xbody1,*cgr1,
    ...
    *clearini1,*prop1,*distmin1,*df21,*dfl21,*dxstiff1,*duds1;
...
// next line is to be inserted in a similar way for all other paralell parts
	...
	ithread[i]=i;
	pthread_create(&tid[i], NULL, (void *)mafillsmdudsmt, (void *)&ithread[i]);
    }
...
void *mafillsmdudsmt(ITG *i){
    ...
    if(!*cyclicsymmetry1){
	FORTRAN(mafillsmduds,(co1,kon1,ipkon1,lakon1,ne1,ipompc1,nodempc1,
