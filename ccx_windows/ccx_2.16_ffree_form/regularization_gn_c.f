...
!
! >
! > \brief regularization function for normal contact mortar
! > see phd-thesis Sitzmann Chapter 3.2.1., semi-smooth Newton for normal contact
! >
! > @param [in]       lambdap         contact pressure in normal direction
...
! > @param [out]       gnc               result regularization function
! > @param [in]        aninvloc        stiffness constant for perturbed Lagrange
