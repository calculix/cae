...
!
      ...
      !
      !       do i=1,nef
      !          write(*,*)'precfd neiel',i,ipnei(i),(neiel(ipnei(i)+j),j=1,6)
      !          write(*,*)'precfd neij',i,ipnei(i),(neij(ipnei(i)+j),j=1,6)
      !          write(*,*)'precfd neifa',i,ipnei(i),(neifa(ipnei(i)+j),j=1,6)
      !       enddo
      !       do k=1,nface
      !          write(*,*) 'precfd ielfa',k,(ielfa(j,k),j=1,4),ifatie(k)
      !       enddo
      !       do k=1,nfaext
      !          write(*,*) 'precfd ifaext',k,ifaext(k)
      !       enddo
      !       write(*,*)
      !
      ...
      !       do i=1,nsolidsurf
      !          write(*,*) 'precfd solidsurf ',i,isolidsurf(i)
      !       enddo
      !
      ...
      !       do i=1,nef
      !          write(*,*) 'precfd vel ',i,(vel(j,i),j=1,3)
      !       enddo
      !
      return
      end
