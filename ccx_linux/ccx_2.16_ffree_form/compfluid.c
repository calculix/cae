...
void compfluid(double **cop, ITG *nk, ITG **ipkonfp, ITG *konf, char **lakonfp,
    ...
    ITG *ipointer=NULL,*mast1=NULL,*irow=NULL,*icol=NULL,*jq=NULL,
      ...
      *ipkonf=NULL,last=0,icyclic,*iau6=NULL,ifixdtimef=0,
      ithermalref,*integerglob=NULL,iincf,ipower=64,
      iconvergence=0,i,*inum=NULL,j,ifreefa,
      *iponofa=NULL,*inofa=NULL,*ia=NULL,*ielpropf=NULL,
      icent=0,isti=0,iqfx=0,nfield,ndim,iorienglob,force=0,icfd=1,
      imach=0,ikappa=0,iatleastonepressurebc,iturb=0,
      *inoel=NULL,*iponoel=NULL,icounter,ischeme=1,isimplec=0,
      iitf,iitg,iitp,*iam=NULL,*jam=NULL,*iamorig=NULL,
      nz_num,*nestart=NULL,*ineighblock=NULL,*neighblock=NULL,
      nneighblock,iit,iito,ip,ierrmax,ncfd,iitpt,
      *inlet=NULL;
    ...
    double *umfa=NULL,reltime,*doubleglob=NULL,dtimefold,
      ...
      *v=NULL,*cosb=NULL,hmin,tincfguess,*h=NULL,
      ...
      *xmach=NULL,*xkappa=NULL,*flux=NULL,*sc=NULL,
