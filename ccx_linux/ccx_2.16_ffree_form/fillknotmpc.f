      ...
      do ii=nmpcold+1,nmpc
         if(labmpc(ii)(1:4).eq.'KNOT') then
            ...
            if(irefnode.ne.irefnodeprev) then
               ...
               !
               !                write(*,*) 'fillknotmpc eigenvalues ',w(1),w(2),w(3)
               ...
               !                write(*,*) 'fillknotmpc iref= ',irefnode,' idim= ',idim
               !
               ...
               if(idim.eq.2) then
                  ...
                  !                   write(*,*) 't1 ',t1(1),t1(2),t1(3)
                  !                   write(*,*) 'e1 ',e1(1),e1(2),e1(3)
                  !                   write(*,*) 'e2 ',e2(1),e2(2),e2(3)
                  !
