...
void rhsmain(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,ITG *ne,
	     ...
	     ITG *nplicon, double *plkcon, ITG *nplkcon, ITG *npmat_, double *ttime,
	     double *time, ITG *istep,ITG *iinc, double *dtime, double *physcon,
	     ITG *ibody, double *xbodyold, double *reltime, double *veold, char *matname,
	     ITG *mi, ITG *ikactmech, ITG *nactmech, ITG *ielprop, double *prop,
...
// next line is to be inserted in a similar way for all other paralell parts
	...
	ipompc1=ipompc;nodempc1=nodempc;coefmpc1=coefmpc;nmpc1=nmpc;nodeforc1=nodeforc;
	...
	t01=t0;t1act1=t1act;ithermal1=ithermal;iprestr1=iprestr;vold1=vold;iperturb1=iperturb;
	...
	physcon1=physcon;ibody1=ibody;xbodyold1=xbodyold;reltime1=reltime;veold1=veold;
	matname1=matname;mi1=mi;ikactmech1=ikactmech;nactmech1=nactmech;ielprop1=ielprop;
	prop1=prop;sti1=sti;xstateini1=xstateini;xstate1=xstate;nstate_1=nstate_;
	ntrans1=ntrans;inotr1=inotr;trab1=trab;

	NNEW(fext1,double,num_cpus**neq1);
	/* calculating the rhs */
...
void *rhsmt(ITG *i){
    ...
    FORTRAN(rhs,(co1,nk1,kon1,ipkon1,lakon1,ne1,ipompc1,nodempc1,
    		  ...
    		  xbodyold1,reltime1,veold1,matname1,mi1,ikactmech1,
    		  nactmech1,ielprop1,prop1,sti1,xstateini1,xstate1,nstate_1,
