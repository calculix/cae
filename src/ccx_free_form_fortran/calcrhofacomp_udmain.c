...
void calcrhofacomp_udmain(ITG *nface,double *vfa,double *shcon,ITG *ielmatf,ITG *ntmat_,
	...
	ithread[i]=i;
	pthread_create(&tid[i], NULL, (void *)calcrhofacomp_ud1mt, (void *)&ithread[i]);
    }
...
void *calcrhofacomp_ud1mt(ITG *i){
    ...
    FORTRAN(calcrhofacomp_ud,(vfa1,shcon1,ielmatf1,ntmat1_,mi1,ielfa1,
